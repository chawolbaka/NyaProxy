...
namespace StringTable
{
    ...
    public class StringTableBuilder
    {
        ...
        internal StringTableBuilderFormat TableFormat { get; set; }
        ...
        internal List<KeyValuePair<MetaRowPositions, Func<StringTableBuilder, string>>> TopMetadataRows = new List<KeyValuePair<MetaRowPositions, Func<StringTableBuilder, string>>>();
        internal List<KeyValuePair<MetaRowPositions, Func<StringTableBuilder, string>>> BottomMetadataRows = new List<KeyValuePair<MetaRowPositions, Func<StringTableBuilder, string>>>();
        ...
        public StringTableBuilder()
        {
            ...
            TableFormat = StringTableBuilderFormat.Default;
        }
        ...
        /// <returns></returns>
        public static StringTableBuilder From(Func<StringTableBaseData> func)
        {
            if (func != null)
            {
        ...
        public static StringTableBuilder From(StringTableBaseData baseData)
        {
        ...
        public static StringTableBuilder From(List<int> list)
        {
            var builder = new StringTableBuilder();
        ...
        public static StringTableBuilder From(List<string> list)
        {
            var builder = new StringTableBuilder();
            foreach (var value in list)
            {
        ...
        public static StringTableBuilder From(List<object> list)
        {
            var builder = new StringTableBuilder();
        ...
        public static StringTableBuilder From(DataTable dt)
        {
            var builder = new StringTableBuilder();
        ...
        public static StringTableBuilder From<T>(List<T> list) where T : class
        {
            var builder = new StringTableBuilder();
            if (list == null)
            {
        ...
        public static StringTableBuilder From(List<object[]> rows)
        {
            var builder = new StringTableBuilder();
        ...
        public static StringTableBuilder From(List<List<object>> rows)
        {
            var builder = new StringTableBuilder();
